...
function TestimonialCard({
	...
	return (
		<div className="relative w-full max-w-xs overflow-hidden rounded-2xl border border-border bg-card p-6">
			<div className="text-foreground/85 text-sm leading-relaxed">{body}</div>
			...
			<div className="mt-5 flex items-center gap-2">
				...
				<div className="flex flex-col">
					<div className="font-medium text-foreground text-sm leading-5 tracking-tight">
						{name}
					</div>
					<div className="text-ink-secondary text-xs leading-5 tracking-tight">
						{username}
					</div>
				</div>
			</div>
			...
			<div className="mx-auto max-w-7xl px-6">
				<div className="mx-auto max-w-[540px] text-center">
					...
					<p className="mt-3 text-ink-secondary text-sm">
						From bookmark organization to RSS reading, our users love how
						ReadrSync simplifies their digital life.
					</p>
				</div>
