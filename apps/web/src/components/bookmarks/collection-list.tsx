			...
			{customCollections.length > 0 && (
				<Collapsible defaultOpen>
					<CollapsibleTrigger asChild>
						<Button
							variant="ghost"
							className="group flex w-full items-center justify-between rounded-md px-4 py-2 font-semibold text-muted-foreground text-sm hover:bg-transparent hover:text-foreground"
						>
